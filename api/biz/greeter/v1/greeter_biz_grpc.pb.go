...
const (
	GreeterService_SayHello_FullMethodName = "/convers.biz.greeter.v1.GreeterService/SayHello"
)
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "convers.biz.greeter.v1.GreeterService",
