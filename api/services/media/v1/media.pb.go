...
var file_media_proto_rawDesc = []byte{
	...
	0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e, 0x76, 0x31, 0x1a, 0x1b, 0x62, 0x75, 0x66, 0x2f, 0x76, 0x61,
	...
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e,
	...
	0x63, 0x65, 0x73, 0x2f, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2f, 0x76, 0x31, 0x3b, 0x6d, 0x65, 0x64,
...
var file_media_proto_goTypes = []any{
	(*HelloRequest)(nil),           // 0: convers.services.media.v1.HelloRequest
	(*HelloReply)(nil),             // 1: convers.services.media.v1.HelloReply
...
var file_media_proto_depIdxs = []int32{
	2,  // 0: convers.services.media.v1.HelloRequest.strVal:type_name -> google.protobuf.StringValue
	3,  // 1: convers.services.media.v1.HelloRequest.floatVal:type_name -> google.protobuf.FloatValue
	4,  // 2: convers.services.media.v1.HelloRequest.doubleVal:type_name -> google.protobuf.DoubleValue
	5,  // 3: convers.services.media.v1.HelloRequest.boolVal:type_name -> google.protobuf.BoolValue
	6,  // 4: convers.services.media.v1.HelloRequest.bytesVal:type_name -> google.protobuf.BytesValue
	7,  // 5: convers.services.media.v1.HelloRequest.int32Val:type_name -> google.protobuf.Int32Value
	8,  // 6: convers.services.media.v1.HelloRequest.uint32Val:type_name -> google.protobuf.UInt32Value
	9,  // 7: convers.services.media.v1.HelloRequest.int64Val:type_name -> google.protobuf.Int64Value
	10, // 8: convers.services.media.v1.HelloRequest.uint64Val:type_name -> google.protobuf.UInt64Value
	0,  // 9: convers.services.media.v1.Greeter.SayHello:input_type -> convers.services.media.v1.HelloRequest
	1,  // 10: convers.services.media.v1.Greeter.SayHello:output_type -> convers.services.media.v1.HelloReply
