...
var file_media_proto_rawDesc = []byte{
	...
	0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x61, 0x79, 0x48, 0x65, 0x6c,
	0x6c, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x22, 0x2e, 0x63, 0x6f, 0x6e, 0x76,
	0x65, 0x72, 0x73, 0x2e, 0x6d, 0x65, 0x64, 0x69, 0x61, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x61, 0x79,
	...
	0x14, 0x0a, 0x0d, 0x4d, 0x65, 0x64, 0x69, 0x61, 0x20, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
...
var file_media_proto_goTypes = []any{
	(*SayHelloRequest)(nil),        // 0: convers.media.v1.SayHelloRequest
	(*SayHelloResponse)(nil),       // 1: convers.media.v1.SayHelloResponse
...
var file_media_proto_depIdxs = []int32{
	2,  // 0: convers.media.v1.SayHelloRequest.str_val:type_name -> google.protobuf.StringValue
	3,  // 1: convers.media.v1.SayHelloRequest.float_val:type_name -> google.protobuf.FloatValue
	4,  // 2: convers.media.v1.SayHelloRequest.double_val:type_name -> google.protobuf.DoubleValue
	5,  // 3: convers.media.v1.SayHelloRequest.bool_val:type_name -> google.protobuf.BoolValue
	6,  // 4: convers.media.v1.SayHelloRequest.bytes_val:type_name -> google.protobuf.BytesValue
	7,  // 5: convers.media.v1.SayHelloRequest.int32_val:type_name -> google.protobuf.Int32Value
	8,  // 6: convers.media.v1.SayHelloRequest.uint32_val:type_name -> google.protobuf.UInt32Value
	9,  // 7: convers.media.v1.SayHelloRequest.int64_val:type_name -> google.protobuf.Int64Value
	10, // 8: convers.media.v1.SayHelloRequest.uint64_val:type_name -> google.protobuf.UInt64Value
	0,  // 9: convers.media.v1.GreeterService.SayHello:input_type -> convers.media.v1.SayHelloRequest
	1,  // 10: convers.media.v1.GreeterService.SayHello:output_type -> convers.media.v1.SayHelloResponse
