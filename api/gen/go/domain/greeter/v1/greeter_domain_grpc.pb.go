...
const (
	GreeterDomainService_SayHello_FullMethodName = "/convers.domain.greeter.v1.GreeterDomainService/SayHello"
)
...
var GreeterDomainService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "convers.domain.greeter.v1.GreeterDomainService",
