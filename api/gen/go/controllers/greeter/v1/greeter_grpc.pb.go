...
const (
	GreeterService_SayHello_FullMethodName = "/convers.controllers.greeter.v1.GreeterService/SayHello"
)
...
var GreeterService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "convers.controllers.greeter.v1.GreeterService",
