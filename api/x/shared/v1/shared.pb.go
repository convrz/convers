...
var file_shared_proto_depIdxs = []int32{
	2,  // 0: convers.shared.v1.HelloRequest.strVal:type_name -> google.pb.StringValue
	3,  // 1: convers.shared.v1.HelloRequest.floatVal:type_name -> google.pb.FloatValue
	4,  // 2: convers.shared.v1.HelloRequest.doubleVal:type_name -> google.pb.DoubleValue
	5,  // 3: convers.shared.v1.HelloRequest.boolVal:type_name -> google.pb.BoolValue
	6,  // 4: convers.shared.v1.HelloRequest.bytesVal:type_name -> google.pb.BytesValue
	7,  // 5: convers.shared.v1.HelloRequest.int32Val:type_name -> google.pb.Int32Value
	8,  // 6: convers.shared.v1.HelloRequest.uint32Val:type_name -> google.pb.UInt32Value
	9,  // 7: convers.shared.v1.HelloRequest.int64Val:type_name -> google.pb.Int64Value
	10, // 8: convers.shared.v1.HelloRequest.uint64Val:type_name -> google.pb.UInt64Value
