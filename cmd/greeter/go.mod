module github.com/makegalxy/galxy/cmd/greeter

go 1.23.3

replace (
	github.com/makegalxy/galxy/module/greeter => ./../../module/greeter
	github.com/makegalxy/galxy/pkg/proto => ./../../pkg/proto
)

require (
	github.com/makegalxy/galxy/module/greeter v0.0.0-00010101000000-000000000000
